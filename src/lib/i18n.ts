...
const DICT: Record<Lang, Dict> = {
    es: {
        ...
        match: {
            error: {
                ...
                BESTOF_INVALID: "El número 'al mejor de' debe ser impar y mayor o igual a 1.",
                INVALID_INPUT: 'Los puntajes deben ser enteros no negativos.',
                TIE_INVALID: 'Empate inválido: la partida requiere un ganador.',
                TOTAL_EXCEEDS: 'La suma de juegos no puede superar {bestOf}.',
                WINNER_WRONG: 'El ganador debe tener exactamente {winsNeeded} victorias.',
                LOSER_TOO_HIGH: 'El perdedor debe tener menos de {winsNeeded} victorias.',
            },
            prelimLabel: 'Previa',
        ...
        podium: {
            ...
            labels: { fourth: '4º puesto', third: '3º puesto', second: '2º puesto', first: 'Campeón' },
        },
    ...
    en: {
        ...
        match: {
            error: {
                nan: 'You must enter two numbers.',
                invalidScore: 'Invalid score for best of {bestOf}. Winner must reach {winsNeeded}.',
                registerFail: 'Could not record the result.',
                BESTOF_INVALID: "The 'best of' number must be an odd integer >= 1.",
                INVALID_INPUT: 'Scores must be non-negative integers.',
                TIE_INVALID: 'Invalid tie: a match requires a winner.',
                TOTAL_EXCEEDS: 'The total number of games cannot exceed {bestOf}.',
                WINNER_WRONG: 'The winner must have exactly {winsNeeded} wins.',
                LOSER_TOO_HIGH: 'The loser must have fewer than {winsNeeded} wins.',
            },
        ...
        podium: { title: 'Tournament finished', pool: 'Total pool: {pool} {currency}', labels: { fourth: '4th place', third: '3rd place', second: '2nd place', first: 'Champion' } },
    ...
    fr: {
        ...
        match: {
            error: {
                nan: 'Vous devez entrer deux nombres.',
                invalidScore: 'Score invalide pour meilleur de {bestOf}. Le gagnant doit atteindre {winsNeeded}.',
                registerFail: 'Impossible d’enregistrer le résultat.',
                BESTOF_INVALID: "Le nombre 'best of' doit être un entier impair ≥ 1.",
                INVALID_INPUT: 'Les scores doivent être des entiers positifs ou nuls.',
                TIE_INVALID: 'Match nul invalide : un match exige un gagnant.',
                TOTAL_EXCEEDS: 'Le nombre total de parties ne peut pas dépasser {bestOf}.',
                WINNER_WRONG: 'Le gagnant doit avoir exactement {winsNeeded} victoires.',
                LOSER_TOO_HIGH: 'Le perdant doit avoir moins de {winsNeeded} victoires.',
            },
            prelimLabel: 'Préliminaire',
            roundLabel: 'Tour {round}',
            pending: 'En attente des qualifiés...',
            vs: 'VS',
            editAria: 'Modifier le résultat',
            confirmEdit: 'Modifier ce résultat effacera les résultats dépendants. Continuer ?',
            boBadge: 'BO{bestOf}',
            placeholderScore: '0',
            byeInfo: 'Passe automatiquement au tour suivant.',
        },
        podium: { title: 'Tournoi terminé', pool: 'Cagnotte totale : {pool} {currency}', labels: { fourth: '4ᵉ place', third: '3ᵉ place', second: '2ᵉ place', first: 'Champion' } },
    ...
    eu: {
        ...
        match: {
            error: {
                ...
                BESTOF_INVALID: "'Best of' zenbakia bikoitza ez den eta 1 baino handiagoa den osoko zenbakia izan behar da.",
                INVALID_INPUT: 'Puntuazioek zenbaki osoak eta ez negatiboak izan behar dute.',
                TIE_INVALID: 'Ezinezko berdinketa: partida batek irabazlea behar du.',
                TOTAL_EXCEEDS: 'Partiden baturak ezin du {bestOf} gainditu.',
                WINNER_WRONG: 'Irabazleak zehazki {winsNeeded} irabazi izan behar ditu.',
                LOSER_TOO_HIGH: 'Galduak {winsNeeded} baino gutxiago izan behar ditu.',
            },
        ...
        podium: {
            ...
            labels: { fourth: '4. postua', third: '3. postua', second: '2. postua', first: 'Txapelduna' },
        },
