...
const DICT: Record<Lang, Dict> = {
    es: {
        ...
        prelim: { card: { prelimRound: 'Ronda previa', target: 'Cuadro objetivo', byes: 'Pasan directas', playPrelim: 'Juegan previa' } },
    ...
    en: {
        ...
        prelim: { card: { prelimRound: 'Preliminary round', target: 'Target bracket', byes: 'Byes', playPrelim: 'Play prelim' } },
    ...
    fr: {
        ...
        prelim: { card: { prelimRound: 'Phase préliminaire', target: 'Tableau cible', byes: 'Qualifiés directs', playPrelim: 'Jouent la préliminaire' } },
    ...
    eu: {
        ...
        create: { label: 'Txapelketa sortu', needPairs: 'Gutxienez 2 bikote behar dituzu txapelketa sortzeko.' },
        prelim: { card: { prelimRound: 'Aurrebaldintza', target: 'Helburu koadroa', byes: 'Zuzen pasatzen dira', playPrelim: 'Aurrebaldintzan jokatzen dute' } },
        summary: { title: 'Koadroaren laburpena', line: 'Bikoteak: {pairs} | Formatua: {bestOf} onena | Hazia: #{seed}' },
        phase: { prelimTitle: 'Aurrebaldintza fasea ({count} partidatan)' },
