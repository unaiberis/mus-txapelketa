...
<div class="space-y-4">
  <div class="flex flex-wrap gap-2 items-center bg-gray-50 p-2 rounded-lg border border-gray-200">
    ...
    <div class="flex flex-wrap gap-2">
      <button class="btn btn-sky" on:click={importPlayers} disabled={randomStageExists || showViewer}>Importar Jugadores</button>
  ...
  <div class="bg-white p-2 rounded-lg border border-gray-200 shadow-sm">
    ...
    <div class="flex flex-wrap gap-2 items-end">
      <div class="flex flex-col gap-1">
        ...
        <input id="pair-a" class="input-field" placeholder="Nombre..." bind:value={pairAName} disabled={randomStageExists || showViewer} />
      </div>
      <div class="flex flex-col gap-1">
        <label for="pair-b" class="text-xs text-gray-500 ml-1">Jugador B</label>
        <input id="pair-b" class="input-field" placeholder="Nombre..." bind:value={pairBName} disabled={randomStageExists || showViewer} />
      </div>
      <button 
        type="button" 
